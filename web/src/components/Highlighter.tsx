...
export default function Highlighter({ item: initialItem }: HighlighterProps) {
    ...
    const addToDocs = (item?: any) => {
        function updateBlock(blocks: any, item: CodeDocs, targetId: string, newData: Snippet) {
            console.log(item, "[][][][][][][][][][")
