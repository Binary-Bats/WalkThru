...
function Highlighter({ filePath, content, startNumber, endLine }) {
    ...
    <div className="flex justify-center mb-5 w-full">
            <div className="w-[100%]  rounded-xl overflow-hidden bg-[#1e1e1e79]" style={containerStyle}>
                <div className="flex justify-center px-1 mt-3  ">
                    <div className="bg-[#252526] w-[95%] rounded-2xl px-10 py-5 text-lg flex items-center" style={headerStyle}>
                        ...
                        <span className=" text-[#858585]"><Path_1.default path={filePath} type={"snippet"} startLine={startNumber} endLine={endLine}> {filePath}</Path_1.default></span>
            ...
            backgroundColor: "#5B4A1E",
                    ...
                    <react_syntax_highlighter_1.Prism language={detectLanguage(filePath)} style={customStyle} showLineNumbers={true} startingLineNumber={startNumber} wrapLines={true}>
                        {content}
